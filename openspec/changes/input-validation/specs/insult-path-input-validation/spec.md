...
- `it("accepts valid path query values and continues normal response flow")`
- `it("returns 400 for invalid path query values and skips Groq call")`
- `it("returns 403 for cross-origin requests even when path is invalid")`
